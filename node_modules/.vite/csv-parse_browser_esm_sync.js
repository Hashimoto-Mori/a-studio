...
var Parser = class extends Transform {
  constructor(opts = {}) {
    super(__spreadProps(__spreadValues(__spreadValues({}, { readableObjectMode: true }), opts), { encoding: null }));
      ...
      if (bom === false) {
        ...
        for (const encoding in boms) {
          if (boms[encoding].compare(buf, 0, boms[encoding].length) === 0) {
            ...
            this.__normalizeOptions(__spreadProps(__spreadValues({}, this.__originalOptions), { encoding }));
            break;
          }
        }
        this.state.bomSkipped = true;
  ...
  __onRecord() {
    const { columns, group_columns_by_name, encoding, info, from: from2, relax_column_count, relax_column_count_less, relax_column_count_more, raw, skip_records_with_empty_values } = this.options;
    ...
    if (from2 === 1 || this.info.records >= from2) {
      ...
      if (columns !== false) {
        ...
        if (raw === true || info === true) {
          ...
          const err = this.__push(objname === void 0 ? extRecord : [obj[objname], extRecord]);
          if (err) {
            return err;
          }
        } else {
          const err = this.__push(objname === void 0 ? obj : [obj[objname], obj]);
          if (err) {
            return err;
          }
        }
        ...
        if (raw === true || info === true) {
          ...
          const err = this.__push(objname === void 0 ? extRecord : [record[objname], extRecord]);
          if (err) {
            return err;
          }
        } else {
          const err = this.__push(objname === void 0 ? record : [record[objname], record]);
          if (err) {
            return err;
          }
        }
  ...
  __error(msg) {
    ...
    if (skip_records_with_error) {
      ...
      this.emit("skip", err, raw ? this.state.rawBuffer.toString(encoding) : void 0);
      return void 0;
    } else {
      return err;
    }
  ...
  __infoRecord() {
    ...
    return __spreadProps(__spreadValues({}, this.__infoDataSet()), {
  ...
  __infoField() {
    ...
    const isColumns = Array.isArray(columns);
    return __spreadProps(__spreadValues({}, this.__infoRecord()), {
...
var parse = function(data, options = {}) {
  ...
  if (err1 !== void 0)
    throw err1;
  const err2 = parser.__parse(void 0, true);
  if (err2 !== void 0)
    throw err2;
  return records;
};
